    ...
    class Solution {
        ...
        public int maximumScore(List<Integer> nums, int k) {
            ...
            Arrays.sort(numAndIndexes,
                    Comparator.comparing(Pair<Integer, Integer>::key, Comparator.reverseOrder())
                            .thenComparingInt(Pair<Integer, Integer>::value));

            for (Pair<Integer, Integer> numAndIndex : numAndIndexes) {
                final int num = numAndIndex.key();
                final int i = numAndIndex.value();
